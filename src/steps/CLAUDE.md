...
7. **Run `npm run check`.** Biome ci, typecheck, tests, build all pass.
8. **Walk through it in the browser** (`npm run dev`) — confirm the doc renders, your new param block renders in the right shape, and the matrix view still makes sense.
